...
class ItemTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // Configure the cell...
        let photoitem = Photoimage[indexPath.row]
        
        cell.imageView?.image = photoitem
    ...
    */
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        // Get the new view controller using segue.destination.
        // Pass the selected object to the new view controller.
            let photoitemViewController = segue.destination as! PhotoItemViewController
            let cell = sender as! ItemTableViewCell
        photoitemViewController.photo = Photoimage[tableView.indexPath(for: cell)!.row]
        //print(photoitemViewController.photoimage.image)
